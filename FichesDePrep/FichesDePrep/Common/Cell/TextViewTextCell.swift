...
class TextViewTextCell: CommonCell {
    ...
    override func setup() {
        ...
        contentView.addConstraints([
            ...
            NSLayoutConstraint(item: textView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .height, multiplier: 1, constant: 100)
        ])
    }
}
